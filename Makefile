...
.PHONY: live
live:
	go test -count=1 -timeout 15m -run 'TestTaskRunSmoke|TestAgentSendAndWaitForResponse|TestBrokerDaemonRewindLive|TestGrokTaskRunSmoke|TestGrokSessionLiveSmoke|TestCodexTaskRunSmoke|TestCodexSessionLiveSmoke|TestBedrockTaskLiveSmoke|TestOllamaTaskLiveSmoke|TestCursorTaskLiveSmoke|TestCursorSessionLiveSmoke|TestCursorSavedSessionResumeLive|TestGoalJourneyLiveBackends|TestMCPLiveLoadAndSessionSeesMnemo|TestMCPExclusiveGrokInspectJourney|TestMCPExclusiveSessionRoundTrip|TestExclusiveGrokSessionResumeLive|TestMCPExclusiveCursorSessionRoundTrip' .
